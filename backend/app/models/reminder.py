...
from sqlalchemy import String, DateTime, Date, Boolean, Text, ForeignKey, Integer, Index
...
class Reminder(Base):
    ...
    __table_args__ = (
        Index("ix_reminder_company_deadline", "company_id", "deadline"),
        Index("ix_reminder_company_completed", "company_id", "completed"),
    )
